...
export const CartIcon = ({
  ...
  const scale = size === "small" ? "scale(1)" : "scale(3.5)";
  const containerSize = size === "small" ? 24 : 100;

  return (
    <Svg width={containerSize} height={containerSize} {...props}>
      {count > 0 && showCount && (
      ...
      <G clipPath="url(#a)" transform={scale}>
        <Path
          fill={isFocused ? "url(#grad)" : "#E7E7E7"}
